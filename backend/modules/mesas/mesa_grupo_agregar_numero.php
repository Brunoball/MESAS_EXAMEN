...
try {
    ...
    if ($id_grupo <= 0 || $numero_mesa <= 0) {
        respond_json(false, 'Parámetros inválidos.', 400);
    }
    ...
    // 🔴 IMPORTANTE:
    // La antigua "Regla PRIORIDAD-1" que bloqueaba si había una mesa prioridad=1
    // con fecha_mesa > fecha_objetivo se ELIMINÓ para permitir agrupar libremente.
